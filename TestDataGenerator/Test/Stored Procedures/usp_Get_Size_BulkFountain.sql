...
Create   Proc [Test].[usp_Get_Size_BulkFountain] (@QuantityRequired int = 100, @ResultOnly bit = 0, @Result tinyint = 0 out)
as
Set nocount on
;
...
insert #test
exec	[BulkFountain].[usp_Get_Size] @QuantityRequired
;
